...
import { favoriteLocation, getAllLocations, getLocation, newLocation, toggleActivation } from '../controller/location.js';
import { protect, verifyAdmin } from '../middlewares/auth.js';
import { newLocationValidator } from '../validator/locationValidator.js';
