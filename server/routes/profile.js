...
import { closeAccount, confirmAccountDelete, deleteAccountRequest, getTotalFunds, resetPassword, resetPasswordEmail, updateProfile, uploadProfilePicture, viewProfile } from "../controller/profile.js";
...
router.put('/close-account', protect, writeLimiter, closeAccount)
router.put('/request-delete-account', protect, writeLimiter, deleteAccountRequest)
router.put('/delete-account', protect, writeLimiter, confirmAccountDelete)
